...
class MediaDrmBridge : public mozilla::jni::ObjectBase<MediaDrmBridge>
{
public:
    static const char name[];

    explicit MediaDrmBridge(const Context& ctx) : ObjectBase<MediaDrmBridge>(ctx) {}
    ...
    static auto New(mozilla::jni::String::Param) -> MediaDrmBridge::LocalRef;
    ...
    auto Init(mozilla::jni::String::Param) const -> bool;
