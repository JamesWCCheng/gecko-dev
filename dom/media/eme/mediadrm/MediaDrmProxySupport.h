...
class MediaDrmProxySupport final
  : public MediaDrmProxy::NativeCallbacksToMediaDrmProxySupport::Natives<MediaDrmProxySupport>
  , public SupportsWeakPtr<MediaDrmProxySupport>
{
public:
  typedef MediaDrmProxy::NativeCallbacksToMediaDrmProxySupport::Natives<MediaDrmProxySupport> MDBridge;

  MOZ_DECLARE_WEAKREFERENCE_TYPENAME(MediaDrmProxySupport);
  ...
  void OnSessionMessage(jni::ByteArray::Param aSessionId,
                        dom::MediaKeyMessageType aSessionMessageType,
                        jni::ByteArray::Param aRequest);
  ...
  void OnError(jni::String aMessage);
  /*
