...
#include "mozilla/MediaDrmBridgeNative.h"
...
public:
  ...
  // Threadsafe. [TODO] check the necessity
...
//  [TODO] Should be unnecessary.
  ...
  const java::MediaDrmBridge::Ref& GetMediaDrmBridge() const { return mCDM->GetMediaDrmBridge(); }
...
//  [TODO] Merge the following with GMPCDMProxy
...
//  [TODO] Merge the following with GMPCDMProxy
  ...
  nsCString mNodeId;
  mozilla::UniquePtr<MediaDrmBridgeNative> mCDM;
  nsAutoPtr<MediaDrmCDMCallbackProxy> mCallback;
  bool mShutdownCalled;

// =====================================================================
// For MediaDrmBridgeNative
